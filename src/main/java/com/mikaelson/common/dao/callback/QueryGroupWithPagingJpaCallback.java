...
// *            - domain type
// */
//public class QueryGroupWithPagingJpaCallback<T> implements JpaCallback<List<T>> {
//
//    // JP-Query string
...
//     *            - instance of Pager
//     */
//    public QueryGroupWithPagingJpaCallback(String queryStr, String countQueryStr, Pager pager) {
