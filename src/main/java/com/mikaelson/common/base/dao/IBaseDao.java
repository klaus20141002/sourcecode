...
//z     * 
    ...
    /**
     * query domain list by hql, with pager variable query parameters
     * @Date        :      2012-5-10
     * @param querySql
     * @param pager
     * @param params
     * @return
     */
    List<T> getListByQueryWithVaParamAndPaging(final String querySql, final String countSql, Pager pager, 
            final Object... params);

    List<T> getAll();
    
    /**
     * Update by native query and map
     * @Date        :      Dec 21, 2014
     * @param queryStr
     * @param paraMap
     */
    void updateByNativeQueryAndMap(final String queryStr, final Map<String, ?> paraMap);
}
